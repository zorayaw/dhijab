<?php 
	 ...
	 * 
	 */
	class PemesananProduksiMei extends CI_Controller
	{
		...
		function __construct()
	  	...
	  	function index(){
	  		if($this->session->userdata('akses') == 2 && $this->session->userdata('masuk') == true){
		       ...
		       $x['datapesanan'] = $this->m_pemesanan->getPemesananProduksiMei();
		       $this->load->view('v_header',$y);
		       $this->load->view('admin/v_sidebar');
		       $this->load->view('admin/v_pemesanan_produksi_Mei',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function savePemesananProduksiMei(){
	  		$nama_pemesan = "admin";
	  		$nama_akun_pemesan ="-";
	  		$no_hp = "-";
	  		$alamat = "-";
			...
			$biaya_admin = 0;
	  		...
	  		echo $this->session->set_flashdata('msg','success');
	       	redirect('Admin/PemesananProduksiMei');		  	
 	  	}

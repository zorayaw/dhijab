			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-12">
							<a href="<?= base_url() ?>stok/Pemesanan/convertExcel?doc=1" target="_blank"
								class="btn btn-success btn-block ripple m-t-10">
						...
						<div class="col-md-12 mt-4">
							<a href="<?= base_url() ?>stok/Pemesanan/convertExcelPerhari?doc=1" target="_blank"
								class="btn btn-success btn-block ripple m-t-10">
				...
				?>
						...
						<form action="<?php echo base_url() ?>stok/Pemesanan/convertExcelBytanggal?doc=1"
							target="_blank" method="post" enctype="multipart/form-data">
							<div class="modal-body p-20">
								<div class="row">
									<div class="col-md-4">

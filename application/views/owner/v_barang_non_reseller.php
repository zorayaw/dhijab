                    ...
                    <div class="modal-body p-20">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control form-white" type="number" min=1 name="stock" placeholder="<?= $barang_stok?> " />
                                </div>
                            </div>  
                    </div>
                    <div class="modal-footer">

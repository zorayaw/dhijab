            ...
            <?php endif?>
				...
				<div class="modal-body">
                  ...
                  ?> <?= date('Y')?>)
						...
						<form action="<?php echo base_url() ?>owner/Transaksi/cetakTransaksiByBulanTanpaTahun?status=<?=$st?>&doc=2" target="_blank"
							method="post" enctype="multipart/form-data">
							<div class="col-md-12">
						...
						<div class="modal-body p-20">
							<div class="row">
								<div class="col-md-4">
									...
									<input class="form-control form-white sd5" onchange="sdd(<?=5?>)" type="date" id="startdatecetak" name="start_date" required />
								</div>
								<div class="col-md-4">
									<label class="control-label">Sampai tanggal:</label>
									<input class="form-control form-white ed5" onchange="sdd(<?=5?>)" type="date" id="enddatecetak" name="end_date" required />
								</div>
								<div class="col-md-4">
									<button type="submit" class="btn btn-success btn-block ripple m-t-10">

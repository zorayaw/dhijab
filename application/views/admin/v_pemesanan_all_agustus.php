...
<div class="content-wrapper">
  <div class="page-title">
    <div class="row">
      <div class="col-sm-6">
        <h4 class="mb-0">Data Daftar Pemesanan (Agustus <?= date('Y')?>)</h4>
      </div>
      <div class="col-sm-6">
              ...
              <tbody>
                ...
                foreach ($datapesanan->result_array() as $i) :
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url() ?>Admin/PemesananAllAgustus/list_barang/<?php echo $pemesanan_id ?>/<?php echo $level ?>" target="_blank" class="btn btn-primary">List Barang</a></td>
                    <td>
                ...
                <div class="form-group col-md-12 mt-10" id="dynamic_field">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      ...
                      <input class="form-control" type="number" name="qty[]" min = 0 required>
                    </div>
                  </div>
                </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <a href="<?= base_url() ?>Owner/Transaksi/cetakTransaksiByBulan?bulan=08&tahun=<?= date("Y")?>" target="_blank" class="btn btn-success btn-block ripple m-t-10">
                  <i class="fa fa-print pr-2"></i>Cetak Pemesanan Bulan Agustus <?= date('Y')?>
                </a>
                <br>
                <br>
              </div>
<!-- 
              ...
              <?php $tahun = date('Y'); ?>
              <div class="col-md-12"><h6>Cetak Berdasarkan Tanggal (Agustus <?= date('Y')?>):</h6></div>
            ...
            <div class="modal-body p-20">
              ...
              <div class="col-md-4">
                ...
                <input class="form-control form-white" type="date" name="start_date" min = "<?=$tahun?>-08-01" max = "<?=$tahun?>-08-31"required/>
              </div>
              <div class="col-md-4">
                <label class="control-label">Sampai tanggal:</label>
                <input class="form-control form-white" type="date" name="end_date" min = "<?=$tahun?>-08-01" max = "<?=$tahun?>-08-31" required/>
              </div>
              <div class="col-md-4">

					...
					<div class="modal fade" id="exportpdfP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
						...
						<div class="modal-dialog" role="document">
                            ...
                            ?>
										...
										<form action="<?php echo base_url() ?>admin/Pemesanan/convertPDFPertanggal?status=3&doc=1" target="_blank"
					...
					<div class="modal fade" id="exportpdfT" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
						...
						<div class="modal-dialog" role="document">
                            ...
                            ?>
										...
										<form action="<?php echo base_url() ?>admin/Pemesanan/convertPDFPertanggal?status=3&doc=2" target="_blank"
											method="post" enctype="multipart/form-data">
											<div class="modal-body p-20">
												<div class="row">
													<div class="col-md-4">

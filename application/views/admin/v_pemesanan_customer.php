...
<div class="content-wrapper">
  <div class="page-title">
    <div class="row">
      <div class="col-sm-6">
        <h4 class="mb-0">Data Pemesanan Customer</h4>
      </div>
      <div class="col-sm-6">
											...
											<div class="modal-body p-20">
												<div class="row">
													<div class="col-md-4">
														...
														<input class="form-control form-white sd" id="startdateexcel" type="date" name="start_date"
															required />
													</div>
													<div class="col-md-4">
														<label class="control-label">End date:</label>
														<input class="form-control form-white ed" id="enddateexcel" type="date" name="end_date"
															required />
													</div>
													<div class="col-md-4">

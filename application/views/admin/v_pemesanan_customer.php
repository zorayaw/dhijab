		...
		<div class="row">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
					<li class="breadcrumb-item"><a href="<?php echo base_url() ?>Admin/PemesananCustomer"
          ...
          ?>
					...
					<div class="modal fade" id="word" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
						...
						<div class="modal-dialog" role="document">
                            ...
                            ?>
										...
										<form action="<?php echo base_url() ?>admin/Pemesanan/convertWordPertanggal?status=1"
											target="_blank" method="post" enctype="multipart/form-data">
											<div class="modal-body p-20">
												<div class="row">
													<div class="col-md-4">
                ...
                ?>
									<tr>
										...
										<td><a
												href="<?php echo base_url() ?>Admin/PemesananCustomer/list_barang/<?php echo $pemesanan_id ?>/<?php echo $level ?>"
    ...
    ?>
			...
			<div class="modal" tabindex="-1" role="dialog" id="Cetak-Pesanan">
				<div class="modal-dialog modal-lg-10">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									<a href="<?= base_url() ?>Owner/Transaksi/cetak_transaksi?status=1" target="_blank"
										class="btn btn-success btn-block ripple m-t-10">
                ...
                ?>
							...
							<form action="<?php echo base_url() ?>Owner/Transaksi/cetakTransaksiBytanggal?status=1" target="_blank"
								method="post" enctype="multipart/form-data">
								<div class="modal-body p-20">
									<div class="row">
										<div class="col-md-4">
											<label class="control-label">Dari tanggal:</label>
											<input class="form-control form-white" id="startdatecetak" type="date" name="start_date"
												required />
										</div>
										<div class="col-md-4">
	...
	<!-- <div class="modal" tabindex="-1" role="dialog" id="produksi">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url() ?>Admin/PemesananCustomer/savepemesananP" method="post" enctype="multipart/form-data">
            <div class="modal-body p-20">
              <div class="row">
	...
	<div class="modal" tabindex="-1" role="dialog" id="editdata<?php echo $pemesanan_id ?>">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form action="<?php echo base_url() ?>Admin/PemesananCustomer/edit_pesanan" method="post"
					enctype="multipart/form-data">
					<div class="modal-body p-20">
						<div class="row">
							<div class="col-md-12">
                      ...
                      ?>
							...
							<div class="col-md-12">
								...
								<select class="form-control" name="kurir" id="editr<?=$pemesanan_id?>"
									onchange="editresi(<?=$pemesanan_id?>)" required>
									<option selected value="">Pilih</option>
									<?php
                      foreach ($kurir->result_array() as $i) :
                        $kurir_id = $i['kurir_id'];

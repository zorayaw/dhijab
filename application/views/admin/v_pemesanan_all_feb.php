    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
          <li class="breadcrumb-item"><a href="<?php echo base_url() ?>Admin/PemesananAllfeb" class="default-color">Home</a></li>
  ...
  <div class="row">
    <div class="col-xl-12 mb-30">
      <div class="card card-statistics h-100">
        ...
        <h6 class="mb-0">Tambah Pemesanan Bulan Februari <?= date('Y')?> :</h6>
      </div>
              ...
              <tbody>
                ...
                foreach ($datapesanan->result_array() as $i) :
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url() ?>Admin/PemesananAllfeb/list_barang/<?php echo $pemesanan_id ?>/<?php echo $level ?>" target="_blank" class="btn btn-primary">List Barang</a></td>
                    <td>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="tambah-pesanan-non-reseller">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url() ?>Admin/PemesananAllfeb/savepemesananNR" method="post" enctype="multipart/form-data">
            <div class="modal-body p-20">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <input class="form-control form-white" type="date" name="tanggal" value = "<?=date('Y')?>-02-01" min = "<?=date('Y')?>-02-01" max = "<?= (date('Y')%4 == 0)? date('Y')."-02-29" : date('Y')."-02-28"?>" required />
                </div>
                <div class="col-md-12">
    ...
    <div class="modal" tabindex="-1" role="dialog" id="reseller">
       <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url() ?>Admin/PemesananAllfeb/savepemesananR" method="post" enctype="multipart/form-data">
            <div class="modal-body p-20">
              <div class="row">
                <div class="col-md-12">
                  <label class="control-label">Nama Pemesan</label>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="produksi">
       <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url() ?>Admin/PemesananAllfeb/savepemesananP" method="post" enctype="multipart/form-data">
            <div class="modal-body p-20">
              <div class="row">
      ...
      <div class="modal" tabindex="-1" role="dialog" id="editdata<?php echo $pemesanan_id ?>">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>Admin/PemesananAllfeb/edit_pesanan" method="post" enctype="multipart/form-data">
              <div class="modal-body p-20">
                <div class="row">
                  <div class="col-md-12">
                    <label class="control-label">Nama Pemesan</label>
      ...
      <div class="modal" tabindex="-1" role="dialog" id="hapusdata<?php echo $pemesanan_id ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body p-20">
              <form action="<?php echo base_url() ?>Admin/PemesananAllfeb/hapus_pesanan" method="post">
                <div class="row">
                  <div class="col-md-12">
                    <input type="hidden" name="pemesanan_id" value="<?php echo $pemesanan_id ?>" />
    ...
    <div class="modal" tabindex="-1" role="dialog" id="bayar<?= $pemesanan_id ?>">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body p-20">
            <form action="<?php echo base_url() ?>Admin/PemesananAllfeb/status" method="POST">
              <div class="row">
                <div class="col-md-12">
                  <input type="hidden" name="pemesanan_id" value="<?php echo $pemesanan_id ?>" />
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <a href="<?= base_url() ?>Owner/Transaksi/cetakTransaksiByBulan?bulan=02&tahun=<?= date("Y")?>" target="_blank" class="btn btn-success btn-block ripple m-t-10">
                  <i class="fa fa-print pr-2"></i>Cetak Pemesanan Bulan Februari <?= date('Y')?>
                </a>
                <br>
              </div>

              <form action="<?php echo base_url() ?>Owner/Transaksi/cetakTransaksiByBulanTanpaTahun?bulan=02" target="_blank" method="post" enctype="multipart/form-data">
              <div class="col-md-12"><h6>Cetak Pemesanan Bulan Februari Berdasarkan Tahun: </h6></div>
...
<!-- 
              ...
              <?php $tahun = date('Y'); ?>
              <div class="col-md-12"><h6>Cetak Berdasarkan Tanggal (Februari <?= date('Y')?>):</h6></div>
            ...
            <div class="modal-body p-20">
              ...
              <div class="col-md-4">
                ...
                <input class="form-control form-white" type="date" name="start_date" value = "<?=$tahun?>-02-01" min = "<?=$tahun?>-02-01" max = "<?= ($tahun%4 == 0)? $tahun."-02-29" : $tahun."-02-28"?>"required/>
              </div>
              <div class="col-md-4">
                <label class="control-label">Sampai tanggal:</label>
                <input class="form-control form-white" type="date" name="end_date" value = "<?=$tahun?>-02-02" min = "<?=$tahun?>-02-02" max = "<?= ($tahun%4 == 0)? $tahun."-02-29" : $tahun."-02-28"?>" required/>
              </div>
              <div class="col-md-4">
               <button type="submit" class="btn btn-success btn-block ripple m-t-10">

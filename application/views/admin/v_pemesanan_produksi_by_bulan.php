...
<div class="content-wrapper">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url() ?>admin/Pemesanan/ConvertExcelByBulanTanpaTahun?status=3&doc=1&bulan=<?= $bulan ?>" target="_blank" method="post" enctype="multipart/form-data">
                      <div class="col-md-12">
                        <h6>Convert Pemesanan Bulan <?= $namaBulan ?> Berdasarkan Tahun: </h6>
                      </div>
                    ...
                    <div class="modal-body p-20">
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <input class="form-control form-white sd2" onchange="sdd(<?= 2 ?>)" type="date" name="start_date" value="<?= $tglawal ?>" min="<?= $tglawal ?>" max="<?= $tglakhir ?>" required />
                        </div>
                        <div class="col-md-4">
                          <label class="control-label">End date:</label>
                          <input class="form-control form-white ed2" onchange="sdd(<?= 2 ?>)" type="date" name="end_date" value="<?= $tglakhir ?>" min="<?= $tglawal ?>" max="<?= $tglakhir ?>" required />
                        </div>
                  ...
                  <form action="<?php echo base_url() ?>admin/Pemesanan/convertWordPertanggal?status=3&doc=1" target="_blank" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                      <div class="row">
                        <div class="col-md-4">
                          <label class="control-label">Start date:</label>
                          <input class="form-control form-white sd3" onchange="sdd(<?= 3 ?>)" type="date" name="start_date" value="<?= $tglawal ?>" min="<?= $tglawal ?>" max="<?= $tglakhir ?>" required />
                        </div>
                        <div class="col-md-4">
                          <label class="control-label">End date:</label>
                          <input class="form-control form-white ed3" onchange="sdd(<?= 3 ?>)" type="date" name="end_date" value="<?= $tglakhir ?>" min="<?= $tglawal ?>" max="<?= $tglakhir ?>" required />
                        </div>
                        <div class="col-md-4">
                          <button type="submit" class="btn btn-success btn-block ripple m-t-10">
                            <i class="fa fa-print pr-2"></i>Convert<br>Pemesanan</a>
                  ...
                  <form action="<?php echo base_url() ?>admin/Pemesanan/convertPDFPertanggal?status=3&doc=1" target="_blank" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                      <div class="row">
                        <div class="col-md-4">
                          <label class="control-label">Start date:</label>
                          <input class="form-control form-white sd4" onchange="sdd(<?= 4 ?>)" type="date" name="start_date" value="<?= $tglawal ?>" min="<?= $tglawal ?>" max="<?= $tglakhir ?>" required />
                        </div>
                        <div class="col-md-4">
                          <label class="control-label">End date:</label>
                          <input class="form-control form-white ed4" onchange="sdd(<?= 4 ?>)" type="date" name="end_date" value="<?= $tglakhir ?>" min="<?= $tglawal ?>" max="<?= $tglakhir ?>" required />
                        </div>
                        <div class="col-md-4">
                          <button type="submit" class="btn btn-success btn-block ripple m-t-10">
                            <i class="fa fa-print pr-2"></i>Convert<br>Pemesanan</a>
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url() ?>admin/Pemesanan/ConvertExcelByBulanTanpaTahun?status=3&doc=2&bulan=<?= $bulan ?>" target="_blank" method="post" enctype="multipart/form-data">
                      <div class="col-md-12">
                        <h6>Convert Transaksi Bulan <?= $namaBulan ?> Berdasarkan Tahun: </h6>
                      </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <?php if ($this->session->userdata('akses') == 2) : ?>
                        <td><a href="<?php echo base_url() ?>admin/PemesananProduksiByBulan/list_barang/<?php echo $pemesanan_id ?>/<?php echo $level ?>?stat=3&bulan=<?= $bulan ?>" target="_blank" class="btn btn-primary">List Barang</a></td>
                      <?php else : ?>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <form action="<?php echo base_url() ?>owner/Transaksi/cetakTransaksiByBulanTanpaTahun?status=3&doc=1&bulan=<?= $bulan ?>" target="_blank" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <h6>Cetak Pemesanan Bulan <?= $namaBulan ?> Berdasarkan Tahun: </h6>
              </div>
  ...
  <div class="modal" tabindex="-1" role="dialog" id="Cetak-Transaksi">
    <div class="modal-dialog modal-lg-10">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Cetak Transaksi Produksi Bulan <?= $namaBulan ?></h5>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <a href="<?= base_url() ?>owner/Transaksi/cetakTransaksiByBulan?status=3&doc=2&bulan=<?= $bulan ?>&tahun=<?= date("Y") ?>" target="_blank" class="btn btn-success btn-block ripple m-t-10">
                <i class="fa fa-print pr-2"></i>Cetak Transaksi Bulan (<?= $namaBulan . " " . date('Y') ?>)
              </a>
              <br>
            </div>

            <form action="<?php echo base_url() ?>owner/Transaksi/cetakTransaksiByBulanTanpaTahun?status=3&doc=2&bulan=<?= $bulan ?>" target="_blank" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
...
<script>
  $('#formsearch').submit(function(e) {
    $.ajax({
      method: "POST",
      url: "<?= base_url() ?>admin/PemesananProduksiByBulan/pemesananByTanggal?bulan=<?= $bulan ?>",
      data: {
        startt: $('#s').val(),
        endd: $('#e').val()
      },

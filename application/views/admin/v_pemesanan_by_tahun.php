        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <?php if ($this->session->userdata('akses') == 2) : ?>
                <td><a href="<?php echo base_url() ?>admin/Pemesanan/list_barang/<?php echo $pemesanan_id ?>/<?php echo $level ?>?stat=<?= $stsp ?>&bulan=<?= $bulan ?>" target="_blank" class="btn btn-primary">List Barang</a></td>
              <?php else : ?>

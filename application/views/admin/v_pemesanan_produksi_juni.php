...
<div class="content-wrapper">
  <div class="page-title">
    <div class="row">
      <div class="col-sm-6">
        <h4 class="mb-0">Pemesanan Produksi Juni</h4>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
          <li class="breadcrumb-item"><a href="<?php echo base_url() ?>Admin/PemesananProduksiJuni" class="default-color">Home</a></li>
              ...
              <tbody>
                ...
                foreach ($datapesanan->result_array() as $i) :
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url() ?>Admin/PemesananProduksiJuni/list_barang/<?php echo $pemesanan_id ?>/<?php echo $level ?>" target="_blank" class="btn btn-primary">List Barang</a></td>
                    <td>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="produksi">
       <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url() ?>Admin/PemesananProduksiJuni/savepemesananproduksi" method="post" enctype="multipart/form-data">
      ...
      <div class="modal" tabindex="-1" role="dialog" id="editdata<?php echo $pemesanan_id ?>">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>Admin/PemesananProduksiJuni/edit_pesanan" method="post" enctype="multipart/form-data">
              <div class="modal-body p-20">
                <div class="row">
                  <div class="col-md-12">
      ...
      <div class="modal" tabindex="-1" role="dialog" id="hapusdata<?php echo $pemesanan_id ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body p-20">
              <form action="<?php echo base_url() ?>Admin/PemesananProduksiJuni/hapus_pesananproduksi" method="post">
                <div class="row">
                  <div class="col-md-12">
                    <input type="hidden" name="pemesanan_id" value="<?php echo $pemesanan_id ?>" />
    ...
    <div class="modal" tabindex="-1" role="dialog" id="bayar<?= $pemesanan_id ?>">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body p-20">
            <form action="<?php echo base_url() ?>Admin/PemesananProduksiJuni/statusproduksi" method="POST">
              <div class="row">
                <div class="col-md-12">
                  <input type="hidden" name="pemesanan_id" value="<?php echo $pemesanan_id ?>" />

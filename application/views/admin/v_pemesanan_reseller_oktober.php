...
<div class="content-wrapper">
  <div class="page-title">
    <div class="row">
      <div class="col-sm-6">
        <h4 class="mb-0">Pemesanan Reseller Oktober</h4>
      </div>
      <div class="col-sm-6">
              ...
              <tbody>
                ...
                foreach ($datapesanan->result_array() as $i) :
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url() ?>Admin/PemesananResellerOktober/list_barang/<?php echo $pemesanan_id ?>/<?php echo $level ?>" target="_blank" class="btn btn-primary">List Barang</a></td>
                    <td>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="reseller">
       <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url() ?>Admin/PemesananResellerOktober/savepemesananreseller" method="post" enctype="multipart/form-data">
      ...
      <div class="modal" tabindex="-1" role="dialog" id="editdata<?php echo $pemesanan_id ?>">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>Admin/PemesananResellerOktober/edit_pesanan" method="post" enctype="multipart/form-data">
              <div class="modal-body p-20">
                <div class="row">
                  <div class="col-md-12">
                    <label class="control-label">Nama Pemesan</label>
      ...
      <div class="modal" tabindex="-1" role="dialog" id="hapusdata<?php echo $pemesanan_id ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body p-20">
              <form action="<?php echo base_url() ?>Admin/PemesananResellerOktober/hapus_pesananreseller" method="post">
                <div class="row">
                  <div class="col-md-12">
                    <input type="hidden" name="pemesanan_id" value="<?php echo $pemesanan_id ?>" />
    ...
    <div class="modal" tabindex="-1" role="dialog" id="bayar<?= $pemesanan_id ?>">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body p-20">
            <form action="<?php echo base_url() ?>Admin/PemesananResellerOktober/statusreseller" method="POST">
              <div class="row">
                <div class="col-md-12">
                  <input type="hidden" name="pemesanan_id" value="<?php echo $pemesanan_id ?>" />
